...
TAGS = ["detr", "slice_size=300", "overlap_ratio=0", "150epochs"]
...
data = dict(
    ...
    train=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/train_300_0.json",
        img_prefix=DATA_ROOT + "sliced/train_images_300_0/",
    ),
    val=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/val_300_0.json",
        img_prefix=DATA_ROOT + "sliced/val_images_300_0/",
    ),
    test=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/val_300_0.json",
...
work_dir = "runs/xview/detr_r50_300_0/"
