...
TAGS = ["detr", "slice_size=400", "overlap_ratio=025", "150epochs"]
...
data = dict(
    ...
    train=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/train_400_025.json",
        img_prefix=DATA_ROOT + "sliced/train_images_400_025/",
    ),
    val=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/val_400_025.json",
        img_prefix=DATA_ROOT + "sliced/val_images_400_025/",
    ),
    test=dict(
        classes=CLASSES,
        ann_file=DATA_ROOT + "sliced/val_400_025.json",
...
work_dir = "runs/xview/detr_r50_400_025/"
